...
export default function CategoryRowList({ bookList }: Props) {
  return (
    <ul>
      {bookList &&
        bookList.map((book) => (
                ...
                <div className='flex flex-col justify-between h-full'>
                  <div className='flex flex-col gap-4'>
                    <div className='flex items-center gap-3'>
                      <h3 className='text-title-24r text-ui-text-title'>{book.title}</h3>
                      <button>
                        <LucideIcons.Heart size={30} className='text-gray-500' />
                      </button>
                    </div>
